...
#pragma warning restore CS8600 // Converting null literal or possible null value to non-nullable type.
            ...
            try
            {
                ...
                _loggerLMM02520.LogInfo(string.Format("Add command parameters in Method {0}", lcMethod));
                ...
                _loggerLMM02520.LogInfo(string.Format("Convert the data in loDataTable to a list of LMM02520DTO objects and assign it to loRtn in Method {0}", lcMethod));
