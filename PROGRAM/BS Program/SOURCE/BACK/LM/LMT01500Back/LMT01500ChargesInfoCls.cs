...
{
    public class LMT01500ChargesInfoCls : R_BusinessObject<LMT01500ChargesInfoDetailDTO>
    {
        private readonly LoggerLMT01500? _loggerLMT01500;
        private readonly ActivitySource _activitySource;

        public LMT01500ChargesInfoCls()
        {
            _loggerLMT01500 = LoggerLMT01500.R_GetInstanceLogger();
            _activitySource = LMT01500Activity.R_GetInstanceActivitySource();
        }

        public LMT01500ChargesInfoHeaderDTO GetChargesInfoHeaderDb(LMT01500UtilitiesParameterDTO poParameterInternal, LMT01500GetHeaderParameterDTO poParameter)
        {
...
#pragma warning restore CS8600 // Converting null literal or possible null value to non-nullable type.
            ...
            LMT01500ChargesInfoHeaderDTO? loRtn = null;
            ...
            try
            {
                ...
                loRtn = R_Utility.R_ConvertTo<LMT01500ChargesInfoHeaderDTO>(loDataTable).FirstOrDefault();
...
#pragma warning restore CS8603 // Possible null reference return.
        ...
        public List<LMT01500ChargesInfoListDTO> GetChargesInfoListDb(LMT01500UtilitiesParameterDTO poParameterInternal, LMT01500GetHeaderParameterDTO poParameter)
        {
            string? lcMethod = nameof(GetChargesInfoListDb);
            _loggerLMT01500.LogInfo(string.Format("Start Method {0}", lcMethod));
            R_Exception loException = new R_Exception();
            List<LMT01500ChargesInfoListDTO>? loReturn = null;
            string lcQuery;
            DbCommand loCommand;
            R_Db loDb;
            try
            {
                ...
                loReturn = R_Utility.R_ConvertTo<LMT01500ChargesInfoListDTO>(loDataTable).ToList();
...
#pragma warning restore CS8603 // Possible null reference return.
        ...
        public List<LMT01500ComboBoxDTO> GetComboBoxDataCFEE_METHODDb(LMT01500UtilitiesWithCultureIDParameterDTO poParameterInternal)
        {
            ...
            try
            {
                ...
                "(@BIMASAKTI, @CCOMPANY_ID, @BS_FEE_MODE, @NONE, @CULTURE_ID);";
                ...
                loDb.R_AddCommandParameter(loCommand, "@CCOMPANY_ID", DbType.String, 20, poParameterInternal.CCOMPANY_ID);
                loDb.R_AddCommandParameter(loCommand, "@BS_FEE_MODE", DbType.String, 15, "_BS_FEE_MODE");
...
#pragma warning restore CS8603 // Possible null reference return.
        ...
        public List<LMT01500ComboBoxDTO> GetComboBoxDataCINVOICE_PERIODDb(LMT01500UtilitiesWithCultureIDParameterDTO poParameterInternal)
        {
...
#pragma warning restore CS8603 // Possible null reference return.
        ...
        protected override LMT01500ChargesInfoDetailDTO R_Display(LMT01500ChargesInfoDetailDTO poEntity)
        {
            string? lcMethod = nameof(R_Display);
            _loggerLMT01500.LogInfo(string.Format("Start Method {0}", lcMethod));
            R_Exception loException = new R_Exception();
            LMT01500ChargesInfoDetailDTO? loRtn = null;
            string lcQuery;
            DbCommand loCommand;
            R_Db loDb;
            ...
            try
            {
                ...
                _loggerLMT01500.LogInfo(string.Format("Set the query string for lcQuery in Method {0}", lcMethod));
                lcQuery = "RSP_LM_GET_AGREEMENT_CHARGES_DT";
                _loggerLMT01500.LogDebug("{@ObjectTextQuery}", lcQuery);
...
#pragma warning disable CS8600 // Converting null literal or possible null value to non-nullable type.
                loRtn = R_Utility.R_ConvertTo<LMT01500ChargesInfoDetailDTO>(loProfileDataTable).FirstOrDefault();
#pragma warning restore CS8600 // Converting null literal or possible null value to non-nullable type.
#pragma warning disable CS8604 // Possible null reference argument.
                _loggerLMT01500.LogDebug("{@ObjectReturn}", loRtn);
#pragma warning restore CS8604 // Possible null reference argument.
...
#pragma warning restore CS8603 // Possible null reference return.
        ...
        protected override void R_Saving(LMT01500ChargesInfoDetailDTO poNewEntity, eCRUDMode poCRUDMode)
        {
...
#pragma warning restore CS8600 // Converting null literal or possible null value to non-nullable type.
            ...
            try
            {
                ...
                _loggerLMT01500.LogInfo(string.Format("Set the query string for lcQuery in Method {0}", lcMethod));
                lcQuery = "RSP_LM_MAINTAIN_AGREEMENT_CHARGES";
                _loggerLMT01500.LogDebug("{@ObjectTextQuery}", lcQuery);
                ...
                loDb.R_AddCommandParameter(loCommand, "@CSEQ_NO", DbType.String, 3, "THIS IS NOT DONE YET");
        ...
        protected override void R_Deleting(LMT01500ChargesInfoDetailDTO poEntity)
        {
