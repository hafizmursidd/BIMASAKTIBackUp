...
{
    public class LMT01500InvoicePlanCls
    {
        private readonly LoggerLMT01500? _loggerLMT01500;
        private readonly ActivitySource _activitySource;

        public LMT01500InvoicePlanCls()
        {
            _loggerLMT01500 = LoggerLMT01500.R_GetInstanceLogger();
            _activitySource = LMT01500Activity.R_GetInstanceActivitySource();
        }

        public LMT01500InvoicePlanHeaderDTO GetInvoicePlanHeaderDb(LMT01500UtilitiesParameterDTO poParameterInternal, LMT01500GetHeaderParameterDTO poParameter)
        {
...
#pragma warning restore CS8600 // Converting null literal or possible null value to non-nullable type.
            ...
            LMT01500InvoicePlanHeaderDTO? loRtn = null;
            ...
            try
            {
                ...
                _loggerLMT01500.LogInfo(string.Format("Convert the data in loDataTable to data of LMT01500InvoicePlanHeaderDTO objects and assign it to loRtn in Method {0}", lcMethod));
                loRtn = R_Utility.R_ConvertTo<LMT01500InvoicePlanHeaderDTO>(loDataTable).FirstOrDefault();
...
#pragma warning restore CS8603 // Possible null reference return.
        ...
        public List<LMT01500InvoicePlanChargesListDTO> GetInvoicePlanChargeListDb(LMT01500UtilitiesParameterDTO poParameterInternal, LMT01500GetHeaderParameterDTO poParameter)
        {
            string? lcMethod = nameof(GetInvoicePlanChargeListDb);
            _loggerLMT01500.LogInfo(string.Format("Start Method {0}", lcMethod));
            R_Exception loException = new R_Exception();
            List<LMT01500InvoicePlanChargesListDTO>? loReturn = null;
            string lcQuery;
            DbCommand loCommand;
            R_Db loDb;
            try
            {
                ...
                _loggerLMT01500.LogInfo(string.Format("Convert the data in loDataTable to a list of LMT01500InvoicePlanChargesListDTO objects and assign it to loRtn in Method {0}", lcMethod));
                loReturn = R_Utility.R_ConvertTo<LMT01500InvoicePlanChargesListDTO>(loDataTable).ToList();
...
#pragma warning restore CS8603 // Possible null reference return.
        ...
        public List<LMT01500InvoicePlanListDTO> GetInvoicePlanListDb(LMT01500UtilitiesParameterDTO poParameterInternal, LMT01500GetHeaderParameterDTO poParameter)
        {
            string? lcMethod = nameof(GetInvoicePlanChargeListDb);
            _loggerLMT01500.LogInfo(string.Format("Start Method {0}", lcMethod));
            R_Exception loException = new R_Exception();
            List<LMT01500InvoicePlanListDTO>? loReturn = null;
            string lcQuery;
            DbCommand loCommand;
            R_Db loDb;
            try
            {
                ...
                _loggerLMT01500.LogInfo(string.Format("Convert the data in loDataTable to a list of LMT01500InvoicePlanListDTO objects and assign it to loRtn in Method {0}", lcMethod));
                loReturn = R_Utility.R_ConvertTo<LMT01500InvoicePlanListDTO>(loDataTable).ToList();
                _loggerLMT01500.LogDebug("{@ObjectReturn}", loReturn);
