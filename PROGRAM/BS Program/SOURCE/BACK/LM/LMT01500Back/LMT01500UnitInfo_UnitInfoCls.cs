...
{
    public class LMT01500UnitInfo_UnitInfoCls : R_BusinessObject<LMT01500UnitInfoUnitInfoDetailDTO>
    {
        private readonly LoggerLMT01500? _loggerLMT01500;
        private readonly ActivitySource _activitySource;

        public LMT01500UnitInfo_UnitInfoCls()
        {
            _loggerLMT01500 = LoggerLMT01500.R_GetInstanceLogger();
            _activitySource = LMT01500Activity.R_GetInstanceActivitySource();
        }

        public LMT01500UnitInfoHeaderDTO GetUnitInfoHeaderDb(LMT01500UtilitiesParameterDTO poParameterInternal, LMT01500GetHeaderParameterDTO poParameter)
        {
...
#pragma warning restore CS8600 // Converting null literal or possible null value to non-nullable type.
            ...
            LMT01500UnitInfoHeaderDTO? loRtn = null;
            ...
            try
            {
                ...
                loRtn = R_Utility.R_ConvertTo<LMT01500UnitInfoHeaderDTO>(loDataTable).FirstOrDefault();
...
#pragma warning restore CS8603 // Possible null reference return.
        ...
        public List<LMT01500UnitInfoUnitInfoListDTO> GetUnitInfoListDb(LMT01500UtilitiesParameterDTO poParameterInternal, LMT01500GetHeaderParameterDTO poParameter)
        {
            string? lcMethod = nameof(GetUnitInfoListDb);
            _loggerLMT01500.LogInfo(string.Format("Start Method {0}", lcMethod));
            R_Exception loException = new R_Exception();
            List<LMT01500UnitInfoUnitInfoListDTO>? loReturn = null;
            string lcQuery;
            DbCommand loCommand;
            R_Db loDb;
            try
            {
                ...
                _loggerLMT01500.LogInfo(string.Format("Set the query string for lcQuery in Method {0}", lcMethod));
                lcQuery = "RSP_LM_GET_AGREEMENT_UNIT_INFO_LIST";
                _loggerLMT01500.LogDebug("{@ObjectTextQuery}", lcQuery);
                ...
                loReturn = R_Utility.R_ConvertTo<LMT01500UnitInfoUnitInfoListDTO>(loDataTable).ToList();
...
#pragma warning restore CS8603 // Possible null reference return.
        ...
        protected override LMT01500UnitInfoUnitInfoDetailDTO R_Display(LMT01500UnitInfoUnitInfoDetailDTO poEntity)
        {
            string? lcMethod = nameof(R_Display);
            _loggerLMT01500.LogInfo(string.Format("Start Method {0}", lcMethod));
            R_Exception loException = new R_Exception();
            LMT01500UnitInfoUnitInfoDetailDTO? loRtn = null;
            string lcQuery;
            DbCommand loCommand;
            R_Db loDb;
            ...
            try
            {
                ...
                _loggerLMT01500.LogInfo(string.Format("Set the query string for lcQuery in Method {0}", lcMethod));
                lcQuery = "RSP_LM_GET_AGREEMENT_UNIT_INFO_DT";
                _loggerLMT01500.LogDebug("{@ObjectTextQuery}", lcQuery);
...
#pragma warning disable CS8600 // Converting null literal or possible null value to non-nullable type.
                loRtn = R_Utility.R_ConvertTo<LMT01500UnitInfoUnitInfoDetailDTO>(loProfileDataTable).FirstOrDefault();
#pragma warning restore CS8600 // Converting null literal or possible null value to non-nullable type.
#pragma warning disable CS8604 // Possible null reference argument.
                _loggerLMT01500.LogDebug("{@ObjectReturn}", loRtn);
#pragma warning restore CS8604 // Possible null reference argument.
...
#pragma warning restore CS8603 // Possible null reference return.
        ...
        protected override void R_Saving(LMT01500UnitInfoUnitInfoDetailDTO poNewEntity, eCRUDMode poCRUDMode)
        {
...
#pragma warning restore CS8600 // Converting null literal or possible null value to non-nullable type.
            ...
            try
            {
                ...
                _loggerLMT01500.LogInfo(string.Format("Set the query string for lcQuery in Method {0}", lcMethod));
                lcQuery = "RSP_LM_MAINTAIN_AGREEMENT_UNIT";
                _loggerLMT01500.LogDebug("{@ObjectTextQuery}", lcQuery);
                ...
                loDb.R_AddCommandParameter(loCommand, "@NACTUAL_AREA_SIZE", DbType.Decimal, 30, poNewEntity.NACTUAL_SIZE_AREA);
                loDb.R_AddCommandParameter(loCommand, "@NCOMMON_AREA_SIZE", DbType.Decimal, 30, poNewEntity.NCOMMON_SIZE_AREA);
        ...
        protected override void R_Deleting(LMT01500UnitInfoUnitInfoDetailDTO poEntity)
        {
...
#pragma warning restore CS8600 // Converting null literal or possible null value to non-nullable type.
            ...
            try
            {
                ...
                loDb.R_AddCommandParameter(loCommand, "@CFLOOR_ID", DbType.String, 20, poEntity.CFLOOR_ID);
                loDb.R_AddCommandParameter(loCommand, "@CBUILDING_ID", DbType.String, 20, poEntity.CBUILDING_ID);
                loDb.R_AddCommandParameter(loCommand, "@NACTUAL_AREA_SIZE", DbType.Decimal, 30, poEntity.NACTUAL_SIZE_AREA);
                loDb.R_AddCommandParameter(loCommand, "@NCOMMON_AREA_SIZE", DbType.Decimal, 30, poEntity.NCOMMON_SIZE_AREA);
