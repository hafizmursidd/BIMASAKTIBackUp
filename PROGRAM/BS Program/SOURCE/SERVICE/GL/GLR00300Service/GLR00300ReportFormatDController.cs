...
namespace GLR00300Service
{
    ...
    public class GLR00300ReportFormatDController
    {
        private R_ReportFastReportBackClass _ReportCls;
        private GLR00300ParamDBToGetReportDTO _Parameter;

        #region instantiate
        public GLR00300ReportFormatDController()
        {
        ...
        {
            pcFileTemplate = "Reports\\GLR00300AccountTrialBalanceFormatD.frx";
        }
        ...
        [HttpPost]
        public R_DownloadFileResultDTO AllTrialBalanceReportPostFormatD(GLR00300ParamDBToGetReportDTO poParameter)
        {
        ...
        public FileStreamResult AllTrialBalanceReportGetFormatD(string pcGuid)
        {
            R_Exception loException = new R_Exception();
