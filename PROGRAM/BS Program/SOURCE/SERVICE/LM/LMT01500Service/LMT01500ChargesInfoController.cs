...
namespace LMT01500Service
{
    ...
    [ApiController]
    public class LMT01500ChargesInfoController : ControllerBase, ILMT01500ChargesInfo
    {
        private readonly LoggerLMT01500? _loggerLMT01500;
        private readonly ActivitySource _activitySource;

        public LMT01500ChargesInfoController(ILogger<LMT01500ChargesInfoController> logger)
        {
        ...
        public LMT01500ChargesInfoHeaderDTO GetChargesInfoHeader(LMT01500GetHeaderParameterDTO poParameter)
        {
            ...
            LMT01500ChargesInfoHeaderDTO? loReturn = null;
            LMT01500ChargesInfoCls loCls;
            ...
            try
            {
                ...
                loCls = new();
                _loggerLMT01500.LogDebug("{@LMT01500ChargesInfoCls}", loCls);
...
#pragma warning restore CS8603 // Possible null reference return.
        ...
        public IAsyncEnumerable<LMT01500ChargesInfoListDTO> GetChargesInfoList()
        {
            ...
            LMT01500UtilitiesParameterDTO? loDbParameterInternal;
            LMT01500GetHeaderParameterDTO? loDbParameter;
            List<LMT01500ChargesInfoListDTO> loRtnTmp;
            LMT01500ChargesInfoCls loCls;
            IAsyncEnumerable<LMT01500ChargesInfoListDTO>? loReturn = null;
...
#pragma warning restore CS8603 // Possible null reference return.
        ...
        [HttpPost]
        public R_ServiceGetRecordResultDTO<LMT01500ChargesInfoDetailDTO> R_ServiceGetRecord(R_ServiceGetRecordParameterDTO<LMT01500ChargesInfoDetailDTO> poParameter)
        {
            string? lcMethod = nameof(R_ServiceGetRecord);
            _loggerLMT01500.LogInfo(string.Format("Start Method {0}", lcMethod));
            var loEx = new R_Exception();
            var loRtn = new R_ServiceGetRecordResultDTO<LMT01500ChargesInfoDetailDTO>();

            try
            {
                _loggerLMT01500.LogInfo(string.Format("Initialize the loCls in method {0}", lcMethod));
                var loCls = new LMT01500ChargesInfoCls();
                _loggerLMT01500.LogDebug("{@LMT01500ChargesInfoCls}", loCls);
        ...
        [HttpPost]
        public R_ServiceSaveResultDTO<LMT01500ChargesInfoDetailDTO> R_ServiceSave(R_ServiceSaveParameterDTO<LMT01500ChargesInfoDetailDTO> poParameter)
        {
...
#pragma warning restore CS8600 // Converting null literal or possible null value to non-nullable type.
            _loggerLMT01500.LogInfo(string.Format("Start Method {0}", lcMethod));
            R_Exception? loException = new R_Exception();
            R_ServiceSaveResultDTO<LMT01500ChargesInfoDetailDTO> loReturn = new();
            try
            {
                _loggerLMT01500.LogInfo(string.Format("Initialize the loCls object as a new instance of Cls in method {0}", lcMethod));
                LMT01500ChargesInfoCls? loCls = new();
                _loggerLMT01500.LogDebug("{@ObjectLMT01500ChargesInfoCls}", loCls);
        ...
        [HttpPost]
        public R_ServiceDeleteResultDTO R_ServiceDelete(R_ServiceDeleteParameterDTO<LMT01500ChargesInfoDetailDTO> poParameter)
        {
