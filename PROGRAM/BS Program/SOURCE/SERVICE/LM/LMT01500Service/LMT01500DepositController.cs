...
namespace LMT01500Service
{
    ...
    [ApiController]
    public class LMT01500DepositController : ControllerBase, ILMT01500Deposit
    {
        private readonly LoggerLMT01500? _loggerLMT01500;
        private readonly ActivitySource _activitySource;

        public LMT01500DepositController(ILogger<LMT01500DepositController> logger)
        {
        ...
        public LMT01500DepositHeaderDTO GetDepositHeader(LMT01500GetHeaderParameterDTO poParameter)
        {
            ...
            LMT01500DepositHeaderDTO? loReturn = null;
            LMT01500DepositCls loCls;
            ...
            try
            {
                ...
                loCls = new();
                _loggerLMT01500.LogDebug("{@LMT01500DepositCls}", loCls);
...
#pragma warning restore CS8603 // Possible null reference return.
        ...
        public IAsyncEnumerable<LMT01500DepositListDTO> GetDepositList()
        {
            ...
            LMT01500UtilitiesParameterDTO? loDbParameterInternal;
            LMT01500GetHeaderParameterDTO? loDbParameter;
            List<LMT01500DepositListDTO> loRtnTmp;
            LMT01500DepositCls loCls;
            IAsyncEnumerable<LMT01500DepositListDTO>? loReturn = null;
...
#pragma warning restore CS8603 // Possible null reference return.
        ...
        [HttpPost]
        public R_ServiceGetRecordResultDTO<LMT01500DepositDetailDTO> R_ServiceGetRecord(R_ServiceGetRecordParameterDTO<LMT01500DepositDetailDTO> poParameter)
        {
            string? lcMethod = nameof(R_ServiceGetRecord);
            _loggerLMT01500.LogInfo(string.Format("Start Method {0}", lcMethod));
            var loEx = new R_Exception();
            var loRtn = new R_ServiceGetRecordResultDTO<LMT01500DepositDetailDTO>();

            try
            {
                _loggerLMT01500.LogInfo(string.Format("Initialize the loCls in method {0}", lcMethod));
                var loCls = new LMT01500DepositCls();
                _loggerLMT01500.LogDebug("{@LMT01500DepositCls}", loCls);
        ...
        [HttpPost]
        public R_ServiceSaveResultDTO<LMT01500DepositDetailDTO> R_ServiceSave(R_ServiceSaveParameterDTO<LMT01500DepositDetailDTO> poParameter)
        {
...
#pragma warning restore CS8600 // Converting null literal or possible null value to non-nullable type.
            _loggerLMT01500.LogInfo(string.Format("Start Method {0}", lcMethod));
            R_Exception? loException = new R_Exception();
            R_ServiceSaveResultDTO<LMT01500DepositDetailDTO> loReturn = new();
            try
            {
                _loggerLMT01500.LogInfo(string.Format("Initialize the loCls object as a new instance of Cls in method {0}", lcMethod));
                LMT01500DepositCls? loCls = new();
                _loggerLMT01500.LogDebug("{@ObjectLMT01500DepositCls}", loCls);
        ...
        [HttpPost]
        public R_ServiceDeleteResultDTO R_ServiceDelete(R_ServiceDeleteParameterDTO<LMT01500DepositDetailDTO> poParameter)
        {
