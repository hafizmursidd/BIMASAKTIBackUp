...
namespace LMT01500Service
{
    ...
    [ApiController]
    public class LMT01500DocumentController : ControllerBase, ILMT01500Document
    {
        private readonly LoggerLMT01500? _loggerLMT01500;
        private readonly ActivitySource _activitySource;

        public LMT01500DocumentController(ILogger<LMT01500DocumentController> logger)
        {
        ...
        public LMT01500DocumentHeaderDTO GetDocumentHeader(LMT01500GetHeaderParameterDTO poParameter)
        {
            ...
            LMT01500DocumentHeaderDTO? loReturn = null;
            LMT01500DocumentCls loCls;
            ...
            try
            {
                ...
                loCls = new();
                _loggerLMT01500.LogDebug("{@LMT01500DocumentCls}", loCls);
...
#pragma warning restore CS8603 // Possible null reference return.
        ...
        public IAsyncEnumerable<LMT01500DocumentListDTO> GetDocumentList()
        {
            ...
            LMT01500UtilitiesParameterDTO? loDbParameterInternal;
            LMT01500GetHeaderParameterDTO? loDbParameter;
            List<LMT01500DocumentListDTO> loRtnTmp;
            LMT01500DocumentCls loCls;
            IAsyncEnumerable<LMT01500DocumentListDTO>? loReturn = null;
...
#pragma warning restore CS8603 // Possible null reference return.
        ...
        [HttpPost]
        public R_ServiceGetRecordResultDTO<LMT01500DocumentDetailDTO> R_ServiceGetRecord(R_ServiceGetRecordParameterDTO<LMT01500DocumentDetailDTO> poParameter)
        {
            string? lcMethod = nameof(R_ServiceGetRecord);
            _loggerLMT01500.LogInfo(string.Format("Start Method {0}", lcMethod));
            var loEx = new R_Exception();
            var loRtn = new R_ServiceGetRecordResultDTO<LMT01500DocumentDetailDTO>();

            try
            {
                _loggerLMT01500.LogInfo(string.Format("Initialize the loCls in method {0}", lcMethod));
                var loCls = new LMT01500DocumentCls();
                _loggerLMT01500.LogDebug("{@LMT01500DocumentCls}", loCls);
        ...
        [HttpPost]
        public R_ServiceSaveResultDTO<LMT01500DocumentDetailDTO> R_ServiceSave(R_ServiceSaveParameterDTO<LMT01500DocumentDetailDTO> poParameter)
        {
...
#pragma warning restore CS8600 // Converting null literal or possible null value to non-nullable type.
            _loggerLMT01500.LogInfo(string.Format("Start Method {0}", lcMethod));
            R_Exception? loException = new R_Exception();
            R_ServiceSaveResultDTO<LMT01500DocumentDetailDTO> loReturn = new();
            try
            {
                _loggerLMT01500.LogInfo(string.Format("Initialize the loCls object as a new instance of Cls in method {0}", lcMethod));
                LMT01500DocumentCls? loCls = new();
                _loggerLMT01500.LogDebug("{@ObjectLMT01500DocumentCls}", loCls);
        ...
        [HttpPost]
        public R_ServiceDeleteResultDTO R_ServiceDelete(R_ServiceDeleteParameterDTO<LMT01500DocumentDetailDTO> poParameter)
        {
